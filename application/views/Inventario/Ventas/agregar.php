...
<div class="row">
  <?php  if(!empty($categorias)):?>
    <?php foreach ($categorias as $categoria):?>
      <div class="col-xl-3 col-sm-4 mb-1">
      <div class="card text-white teal o-hidden h-100">
        <button class="card-body teal" id="pro" value="<?php echo $categoria->idCategoria;?>" type="button" data-toggle="modal" data-target="#modal-productos">

          <div class="h4 text-white text-center"><?php echo $categoria->categoriaProd;?></div>
        </button>
      </div>
    </div>
    <?php endforeach; ?>
    ...
    <table id="tbventas" class="table table-bordered table-striped table-hover" >
      <thead>
        <tr>
          ...
          <th style="font-family: Arial; font-size: 15pt;">Nombre</th>
          <th style="display:none;">Presentacion</th>
          <th style="font-family: Arial; font-size: 15pt;">Existencias</th>
          <th style="display:none;">Precio Unitario</th>
          <th style="font-family: Arial; font-size: 15pt;">Cantidad</th>
          <th style="display:none;">IVA</th>
          <th style="display:none;">SubTotal</th>
          <th style="font-family: Arial; font-size: 15pt;">SubTotal</th>
          <th style="font-family: Arial; font-size: 15pt;">Quitar</th>
        </tr>
      </thead>
      <tbody>
...
<div class="row">
  <div class="col-md-3">
    <div class="form-group">
      <div class="input-group">
        ...
        <input style="font-family: Arial; font-size: 25pt;" type="text" id="total" class="form-control" required data-readonly onfocus="this.blur();" name="Total" value="">
      </div>
    </div>
  </div>
  <div class="col-md-3" id="change">
    <div class="input-group">
      ...
      <input style="font-family: Arial; font-size: 25pt;" type="text" id="recibe" class="form-control" placeholder="" name="recibe" value="0" >
    </div>
  </div>
  <div class="col-md-3">
    <div class="input-group">
      <span class="input-group-text">Cambio:</span>
      <input style="font-family: Arial; font-size: 25pt;" type="text" id="cambio" class="form-control" placeholder="" name="cambio" value="" readonly>
    </div>
  </div>
  <div class="col-md-3">
    <div class="input-group">
