...
<div class="container-fluid">
  ...
  <div class="col-md-6">
    <div class="form-group">
        <label for="">Razon despacho:</label>
    ...
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <span class="btn-group">
          <button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#modal-sucDes" ><span class="fa fa-search"></span> </button>
        </span>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modal-sucDes">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
            ...
            <?php  if(!empty($sucursales)):?>
              <?php foreach ($sucursales as $sucursal):?>
               <tr>
                ...
                <td>
                  <button type="button" class="btn btn-success btn-sucDesp btn-sm" value="<?php echo $datasucursal?>"><span class="fa fa-check"></span></button>
                </td>
              </tr>
            <?php endforeach; ?>
          <?php endif; ?>
