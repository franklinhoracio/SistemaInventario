 <head>
  ...
  <title>Realizar Traslados</title>
</head>
<body>
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><span class="font-weight-bold">Nuevo Traslado</span></li>
    </ol>
  </div>
...
<div class="container-fluid">
  <form action="<?php echo base_url();?>Inventario/Traslados/store" method="POST">
      ...
      <div class="form-group">
        ...
        <select name="comprobantes" id="comprobantes" class="form-control" required>
          ...
          <?php foreach($comprobante as $comprobantes):?>
            <?php if ($comprobantes->tipoDocumento == "Requisicion"): ?>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="">Fecha del Traslado:</label>
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="form-group">
        <label for="">Sucursal que envia:</label>
  ...
  <div class="col-md-3">
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <span class="btn-group">
          <button id="proInventario" class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#modal-productos" ><span class="fa fa-search"></span> </button>
        </span>
      </div>
    </div>
  </div>
...
<div class="form-group" style="overflow-x:scroll">
  <div class="col-md-12">
    <table id="tbtraslado" class="table table-bordered table-striped table-hover" >
      <thead>
        <tr>
