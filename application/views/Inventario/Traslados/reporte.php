<?php  
$fecha = date("d/m/Y", strtotime($traslados->fecha));
require_once(APPPATH.'libraries/fpdf/fpdf.php');
$pdf = new FPDF('L','mm','A4');
$pdf->AddPage();
$pdf->Ln(0);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(88,3,utf8_decode('Orden de Traslado #'.$traslados->numDocumento.' '. $fecha),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(122,3,utf8_decode('Orden de Traslado #'.$traslados->numDocumento.' '. $fecha),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(60,3,utf8_decode('Orden de Traslado #'.$traslados->numDocumento.' '. $fecha),0,1,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(88,3,utf8_decode('Sucursal que envia: '.$traslados->sucursale),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(122,3,utf8_decode('Sucursal que envia: '.$traslados->sucursale),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(60,3,utf8_decode('Sucursal que envia: '.$traslados->sucursale),0,1,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(88,3,utf8_decode('Sucursal que recibe: '.$traslados->sucursalr),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(122,3,utf8_decode('Sucursal que recibe: '.$traslados->sucursalr),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(60,3,utf8_decode('Sucursal que recibe: '.$traslados->sucursalr),0,1,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(88,3,utf8_decode('Transportista: '.$traslados->Nombre),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(122,3,utf8_decode('Transportista: '.$traslados->Nombre),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(60,3,utf8_decode('Transportista: '.$traslados->Nombre),0,1,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(88,5,utf8_decode('Realizado Por: '.$traslados->usuario),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(122,5,utf8_decode('Realizado Por: '.$traslados->usuario),0,0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(60,5,utf8_decode('Realizado Por: '.$traslados->usuario),0,1,'C');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(25,3,utf8_decode('$'.round($traslados->importeTraslado,2)),0,0,'L');

$pdf->SetFont('Arial','B',8);
$pdf->Cell(71,3,utf8_decode('Total:'),0,0,'L');
$pdf->SetFont('Arial','',8);
$pdf->Cell(27,3,utf8_decode('$'.round($traslados->importeTraslado,2)),0,0,'L');

$pdf->SetFont('Arial','B',8);
$pdf->Cell(73,3,utf8_decode('Total:'),0,0,'L');
$pdf->SetFont('Arial','',8);
$pdf->Cell(10,3,utf8_decode('$'.round($traslados->importeTraslado,2)),0,1,'L');
...
$pdf->Cell(38,1,utf8_decode('   		     Transportista:'),0,0,'J');
$pdf->Cell(58,1,utf8_decode('           Transportista:'),0,0,'J');

$pdf->Cell(38,1,utf8_decode('Transportista:'),0,0,'C');
$pdf->Cell(58,1,utf8_decode('              Transportista:'),0,0,'J');

$pdf->Cell(38,1,utf8_decode('     Transportista:'),0,0,'C');
$pdf->Cell(40,1,utf8_decode('                 Transportista:'),0,0,'J');
