...
<?php endif;?>
<div class="container-fluid">
  <form action="<?php echo base_url();?>Inventario/Proveedores/store" method="POST" >
    <div class="row">
      <div class="col-md-5">
        <div class="form-group <?php echo !empty(form_error("proveedor"))?'has-danger':''?>">   
          <label for="proveedor">Proveedor:</label>
          <input type="text" class="form-control" id="proveedor" name="proveedor" value="<?php echo set_value("proveedor");?>">
      ...
      <div class="col-md-3">
        <div class="form-group <?php echo !empty(form_error("registroFiscal"))?'has-danger':''?>">   
          ...
          <input type="text" class="form-control" id="registroFiscal" name="registroFiscal" value="<?php echo set_value("registroFiscal");?>">
    ...
    <div class="row">      
      <div class="col-md-5">
        <div class="form-group <?php echo !empty(form_error("nombreContacto"))?'has-danger':''?>">   
          ...
          <input type="text" class="form-control" id="nombreContacto" name="nombreContacto" value="<?php echo set_value("nombreContacto");?>">
      ...
      <div class="col-md-3">
        <div class="form-group <?php echo !empty(form_error("telefonoContacto"))?'has-danger':''?>">   
          <label for="telefonoContacto">Teléfon Contacto:</label>
          <input type="text" class="form-control" id="telefonoContacto" name="telefonoContacto" value="<?php echo set_value("telefonoContacto");?>">
