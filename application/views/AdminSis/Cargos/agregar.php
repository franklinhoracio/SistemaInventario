...
<body>
  ...
  <div class="col-md-5">
      ...
      <?php endif;?>
  <div class="container-fluid">
    <form action="<?php echo base_url();?>Administracion/Cargos/store" method="POST" >
      <div class="row">
        <div class="col-md-3">
          <div class="form-group <?php echo !empty(form_error("cargo"))?'has-danger':''?>">   
            <label for="cargo">Cargo:</label>
            <input type="text" class="form-control" id="cargo" name="cargo" value="<?php echo set_value("cargo");?>">
