...
<body>
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><span class="font-weight-bold">Edición Presentación</span></li>
    </ol>
  </div>
...
<?php endif;?>
<div class="container-fluid">
  <form action="<?php echo base_url();?>Administracion/Presentaciones/actualizar" method="POST" >
    <input type="hidden" value="<?php echo $presentacion->idPresentacion;?>" name="codigo">
    <div class="row">
      <div class="col-md-3">
        <div class="form-group <?php echo !empty(form_error("presentacion"))?'has-danger':''?>">   
          <label for="presentacion">Presentación:</label>
          <input type="text" class="form-control" id="presentacion" name="presentacion" value="<?php echo $presentacion->presentacion;?>">
