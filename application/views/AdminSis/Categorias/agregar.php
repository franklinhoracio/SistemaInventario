...
<body>
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?php echo base_url();?>Administracion/Categorias/index/1"><span class="font-weight-bold">Categorias</span></a></li>
      <li class="breadcrumb-item"><span class="font-weight-bold">Nueva Categoría</span></li>
    </ol>
  </div>
  ...
  <div class="col-md-5">
      ...
      <?php endif;?>
  <div class="container-fluid">
    <form action="<?php echo base_url();?>Administracion/Categorias/store" method="POST" >
      <div class="row">
        <div class="col-md-3">
