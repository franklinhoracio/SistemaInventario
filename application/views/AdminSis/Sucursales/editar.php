...
<body>
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><span class="font-weight-bold">Edición Sucursal</span></li>
    </ol>
  </div>
...
<?php endif;?>
<div class="container-fluid">
  <form action="<?php echo base_url();?>Administracion/Sucursales/actualizar" method="POST" >
    <input type="hidden" value="<?php echo $sucursal->idSucursal;?>" name="codigo">
    <div class="row">
      <div class="col-md-3">
        <div class="form-group <?php echo !empty(form_error("sucursal"))?'has-danger':''?>">   
          <label for="sucursal">Sucursal:</label>
          <input type="text" class="form-control" id="sucursal" name="sucursal" value="<?php echo $sucursal->sucursal;?>">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group <?php echo !empty(form_error("ubicacion"))?'has-danger':''?>">   
          ...
          <input type="text" class="form-control" id="ubicacion" name="ubicacion" value="<?php echo $sucursal->ubicacion;?>">
