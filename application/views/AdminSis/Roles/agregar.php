...
<body>
  <div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?php echo base_url();?>Administracion/Roles/index/1"><span class="font-weight-bold">Roles</span></a></li>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group <?php echo !empty(form_error("rol"))?'has-danger':''?>">   
            ...
            <input type="text" class="form-control" id="rol" name="rol" value="<?php echo set_value("rol");?>">
